...
class EntityLinkingAPIs:
    ...
    def run(self) -> dict:
        ...
        linked_entities = self.link_non_identical_entities(linked_entities, wat_results, lookup_results, falcon_results,
                                                           self.academicDisciplines)
    ...
    def link_non_identical_entities(self, linked_entities: dict, wat_results: dict, lookup_results: dict,
                                    falcon_results: dict, academicDisciplines: pd.DataFrame) -> dict:
        """
        A function that iterated through the API results of 1. WAT API, 2. DBpedia Lookup, and 3. FALCON API
